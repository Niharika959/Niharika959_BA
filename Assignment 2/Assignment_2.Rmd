...
```{r}
return_rate <- Online_Retail_new %>% filter(Country=='France')
cancelled_customers <- nrow(subset(return_rate,TransactionValue<0))
View(cancelled_customers)

return_rate_french_cust=(cancelled_customers/8556)
